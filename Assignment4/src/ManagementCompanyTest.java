...
public class ManagementCompanyTest {
    ...
    public void testGetProperty() {
        ManagementCompany mc = new ManagementCompany("Campus Realty", "123-45-6789");
        Property p = new Property("Apt 5", "Laurel", 1700.0, "Frank");
        mc.addProperty(p);

        assertEquals("Apt 5", mc.getProperty(0).getPropertyName());
    ...
    public void testToString() {
        ManagementCompany mc = new ManagementCompany("Campus Realty", "123-45-6789");
        mc.addProperty(new Property("Apt 1", "Rockville", 1200.0, "Bob"));

        String output = mc.toString();

        assertTrue(output.contains("Campus Realty"));
        assertTrue(output.contains("123-45-6789"));
        assertTrue(output.contains("Apt 1"));
        assertTrue(output.contains("1200.0"));
    }
}
